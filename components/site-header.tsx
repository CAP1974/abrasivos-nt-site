...
export function SiteHeader() {
  ...
  return (
    <header style={{
      ...
      boxShadow: "0 18px 46px rgba(4,8,9,0.32)"
    }}>
      <div className="container-shell" style={{ paddingTop: 14, paddingBottom: 14 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
          ...
          <Link href="/" style={{ display: "flex", alignItems: "center", gap: 16, textDecoration: "none" }}>
            <div style={{
              display: "flex", height: 48, width: 72, flexShrink: 0,
              alignItems: "center", justifyContent: "center",
              borderRadius: 18, border: "1px solid rgba(255,255,255,0.1)",
              background: "rgba(255,255,255,0.04)", padding: "0 8px"
            }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/abrasivos-nt-logo.png" alt="Abrasivos NT" style={{ height: 32, width: "auto" }} />
            </div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{
                fontSize: 13, fontWeight: 700, textTransform: "uppercase",
                letterSpacing: "0.34em", color: "#e2b96e",
            ...
            {navigation.map((item) => (
              <Link
                ...
                style={{
                  ...
                  textDecoration: "none",
                  color: pathname === item.href ? "#ffffff" : "#bbbbbb",
        ...
        {mobileOpen && (
          <div style={{
            ...
            marginTop: 12, paddingTop: 12, paddingBottom: 8, gap: 2
          }}>
            {navigation.map((item) => (
              <Link
                key={item.href}
            ...
            <Link
              ...
              style={{
                ...
                fontSize: 13, fontWeight: 700,
                textTransform: "uppercase", letterSpacing: "0.06em",
                background: "#c9984f", color: "#071012", textDecoration: "none",
              }}
            >
              {cta.primaryQuote}
            </Link>
